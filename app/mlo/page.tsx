        ...
        <div className="p-6">
          ...
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-3">
              <div className="h-14 w-14 rounded-2xl bg-gradient-to-br from-chart-5 to-destructive flex items-center justify-center glow-sm">
                <MapPin className="h-7 w-7 text-white" />
              </div>
              <div>
                <div className="flex items-center gap-3">
                  <h1 className="text-3xl font-bold text-foreground">Maps & MLO</h1>
          ...
          {isLoading ? (
            ...
            <div className="glass rounded-2xl flex flex-col items-center justify-center py-20">
              ...
              <h3 className="text-xl font-semibold text-foreground">No MLOs found</h3>
