...
const quickLinks = [
  ...
  { title: "Forum", href: "/admin/forum", icon: MessageSquare, color: "purple", desc: "Moderate posts" },
  { title: "Spin Wheel", href: "/admin/spin-wheel", icon: Sparkles, color: "yellow", desc: "Prize system" },
  { title: "Assets", href: "/admin/assets", icon: FileText, color: "orange", desc: "Review assets" },
        ...
        <Card className="glass glass-hover">
          ...
          <CardContent className="space-y-3">
            ...
            <div className="flex items-center justify-between p-4 rounded-xl glass-hover group">
              ...
              <div className="flex items-center gap-2">
                <Badge variant="secondary" className="group-hover:scale-110 transition-transform">
                  {stats?.totalThreads || 0} total
                </Badge>
                <Badge 
                  variant={stats?.pendingThreads ? "destructive" : "secondary"}
                  className="group-hover:scale-110 transition-transform"
                >
                  {stats?.pendingThreads || 0} pending
                </Badge>
              </div>
            </div>
          </CardContent>
